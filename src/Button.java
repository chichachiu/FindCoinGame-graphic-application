...
/**
 * This class implements two buttons. A button to restart the game and a button to take a screenshot
 * of the game scene. The color of the button changes from a dark to light blue if the mouse is over
 * it (being selected) or not.
 *
 */
public class Button implements Clickable {
  ...
  public boolean isMouseOver() {
    if (processing.mouseX >= this.x
        && processing.mouseX <= (this.x + WIDTH)
