...
public class TreasureHunt extends PApplet {
  ...
  public void initGame() {
    ...
    RestartGameButton rButton = new RestartGameButton(0, 0);
    ScreenshotButton sButton = new ScreenshotButton(140, 0);
    this.gameObjects.add(rButton);
    this.gameObjects.add(sButton);
  }
   ...
   * @return a reference to an interactive object with the specified name, or null when none is found
   */
